...
def process_input_file(input_file_name, output_file_name, start_from=1):
    ...
    with open(input_file_name, 'r') as input_file:
        with open(output_file_name, 'a') as output_file:  # 'a' mode to append in case of restarts
...
output_file = "/home/riotu/Dropbox/Adel/ChatGPT/ROSGPT/final-NL-commands/Converted_JSON_commands_UAV_GPT4.txt"
process_input_file(input_file, output_file, start_from=19)
